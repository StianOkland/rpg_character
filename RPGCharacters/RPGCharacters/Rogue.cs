...
namespace rpg_character
{
    public class Rogue : Role
    {
        ...
        public Rogue()
        {
            CharacterType = RoleType.ROGUE;
            validWeapons = new WeaponType[] { WeaponType.DAGGERS, WeaponType.SWORDS };
            validArmors = new ArmorType[] { ArmorType.LEATHER, ArmorType.MAIL };
            BasePrimaryStats = new Stats() { Strength = 2, Dexterity = 6, Intelligence = 1 };
            LevelupStats = new Stats() { Strength = 1, Dexterity = 4, Intelligence = 1 };
